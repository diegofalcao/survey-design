...
# This class models the Ford-Fulkerson method in order to compute the maxflow
# of a network flow.
class FordFulkerson:
    def __init__(self):
        self.adjacency_list = {}
    ...
    # It uses the BFS algorithm to walk on the flow network
    ...
    # It calculates the max flow for the flow network.
    ...
    # It checks if there is a feasible circulation
    def is_feasible_circulation(self, total_sum, max_flow_result):
        return max_flow_result == total_sum

    # It loads the dataset in our defined data structure in the memory
